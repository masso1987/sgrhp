...
function seed() {
  ...
  const pf1 = { id: id("pf"), name: "Industrial Clients", required: ["I","III","IV","V","VII","IX","X","XI","XVI"] };
  const pf2 = { id: id("pf"), name: "Banking & Services", required: ["I","III","IV","V","VII","VIII","IX","X","XVII"] };
  const pf3 = { id: id("pf"), name: "Head Office Staff",  required: ["III","IV","V","IX","X"] };
