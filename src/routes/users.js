...
const SMQ_CAPS = ["smq.processes", "smq.documents", "smq.axes", "smq.stakeholders", "smq.indicators", "smq.scope", "smq.clauses", "smq.policy", "smq.improvements", "smq.tracability", "smq.admin"];
